...
const Dropdown = ({
  ...
  return (
    <div className="flex font-mukta text-gray-900 whitespace-nowrap sm:text-md md:text-lg gap-5 z-50">
      <label className="sm:hidden md:block pt-2">Results per page</label>
      <div className="relative">
        ...
        {isDropdownOpen && (
          <div className="sm:text-md md:text-lg font-light z-30 rounded overflow-hidden bg-cloud absolute mt-3 w-full text-center">
            <ul className="flex text-lg flex-col border-gray-400 border">
              <li className="cursor-pointer sm:py-2 md:py-3 border-b hover:bg-gray-200 border-gray-400" onClick={() =>{
                setResults(5)
